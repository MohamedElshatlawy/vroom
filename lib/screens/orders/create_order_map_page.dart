...
class CreateOrderMapPage extends StatelessWidget {
  CreateOrderMapPage({
    this.choosePoint,
  });
            ...
            child: Consumer(
              builder: (context, watch, widget) {
                final Map<MarkerId, Marker> markers =
                    watch(createOrderMarkersProvider).state;
                final LatLng start= watch(startingPointProvider).state;
                watch(endingPointProvider).state;
                return GoogleMap(
                  ...
                  onTap: (value) {
                    if (choosePoint == PointsEnum.start) {
                      ...
                      context.read(createOrderMarkersProvider).state[markerId] =
                          Marker(
                      ...
                      context.read(startingPointProvider).state = value;
                      ...
                      context.read(endingPointProvider).state = value;
                      ViewFunctions.getAddressByCoordinates(
                        context: context,
                        location: value,
